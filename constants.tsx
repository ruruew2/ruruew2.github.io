...
export const PROJECTS: Project[] = [
  ...
  },
  {
    id: '2',
    name: 'AI 챗봇 비서',
    description: 'Gemini API를 활용한 스마트 일정 관리 도우미',
    url: '/ai-assistant',
    icon: '🤖'
  },
  {
    id: '3',
    name: '개인 블로그',
    description: 'Next.js와 Notion API를 연동한 개발 기록 저장소',
